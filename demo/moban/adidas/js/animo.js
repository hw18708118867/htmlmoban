...
;(function ( $, window, document, undefined ) {
     ...
     * Modern browsers and almost all mobile browsers support CSS animations (http://caniuse.com/less-animation).
     *
    ...
    $.fn.animo2 = function(animation,duration,iterate,keep,callback,other_cb){
        var options = {
            animation:animation,
            duration:duration,
            iterate:iterate,
