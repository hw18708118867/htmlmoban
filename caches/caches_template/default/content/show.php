...
$("a.fancybox").fancybox();
  ...
  <div class="Main1 constr" id="content-container">
            <div class="News FL">
                <ul class="new_li">
                    <div id="scrollDiv">
                        <div class="scrollText">
                            <ul style="margin-top: 0px; ">
                                <li>
                                    <a href="javascript:;" title='wordpress主题下载站 — 爱找主题 即将迎来第四版改版！' target="_blank">
                                        wordpress主题下载站 — 爱找主题 即将迎来第四版改版
                                    </a>
                                </li>
                                <li>
        ...
        <div class="AD_1080_1">
            <a target="_blank" rel="nofollow" href="javascript:;">
                <img src="./images/weixiang.jpg" width="1080" alt="wordpress主题推荐">
            </a>
        </div>
-->
