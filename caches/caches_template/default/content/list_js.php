...
<div id="m">
	...
	<div class="slogan">
	    <span class="js"></span>
	    <div class="text">化繁为简，我们帮助您更好的运用代码。给你的代码都是选之又选，懒人图库拒绝滥竽充数！<br /><a href="http://baike.baidu.com/view/2160733.htm" target="_blank">什么是JS代码？</a> 　<a href="http://baike.baidu.com/view/1020297.htm" target="_blank">什么是jquery？</a> 　<a href="http://baike.baidu.com/view/951383.htm" target="_blank">什么是HTML5？</a>
	    </div>
	</div>
	<div class="list-pngjs clearfix">
		<dl>
		   <?php if(defined('IN_ADMIN')  && !defined('HTML')) {echo "<div class=\"admin_piao\" pc_action=\"content\" data=\"op=content&tag_md5=e95a7d3aa4116814e3ccbc0a4d0b85a8&action=lists&catid=%24catid&num=18&order=id+DESC&page=%24page\"><a href=\"javascript:void(0)\" class=\"admin_piao_edit\">编辑</a>";}$content_tag = pc_base::load_app_class("content_tag", "content");if (method_exists($content_tag, 'lists')) {$pagesize = 18;$page = intval($page) ? intval($page) : 1;if($page<=0){$page=1;}$offset = ($page - 1) * $pagesize;$content_total = $content_tag->count(array('catid'=>$catid,'order'=>'id DESC','limit'=>$offset.",".$pagesize,'action'=>'lists',));$pages = pages($content_total, $page, $pagesize, $urlrule);$data = $content_tag->lists(array('catid'=>$catid,'order'=>'id DESC','limit'=>$offset.",".$pagesize,'action'=>'lists',));}?>
			...
			<dd><a href="<?php echo $v['url'];?>" target="_blank"><img alt="<?php echo $v['title'];?>" src="<?php echo $v['thumb'];?>" /><?php echo $v['title'];?></a><span>焦点图</span></dd> 
			 <?php $n++;}unset($n); ?>
...
<dd><a href="/js/nav.html">导航菜单</a></dd><dd><a href="/js/form.html">表单按钮</a></dd><dd><a href="/js/text.html">文字特效</a></dd><dd><a href="/js/table.html">表格图层</a></dd><dd><a href="/js/picture.html">图片特效</a></dd><dd><a href="/js/date.html">时间日期</a></dd><dd><a href="/js/scroll.html">滚动代码</a></dd><dd><a href="/js/window.html">窗口特效</a></dd><dd><a href="/js/color.html">颜色背景</a></dd><dd><a href="/js/website.html">网站常用</a></dd><dd><a href="/js/css.html">CSS样式</a></dd><dd><a href="/js/other.html">其他特效</a></dd>				 
	...
	<div class="h">
		 <dl>
			<dt>这些是最新的...</dt>
			<dd><a href="/js/css-1178.html"><p><img src="<?php echo IMG_PATH;?>2zzt_logo.png" class="f"/></p>CSS布局：上中下三栏自适应高度CSS布局<span class="l">CSS样式</span><span class="t">2015-01-19</span></a></dd><dd><a href="/js/text-1065.html"><p><img src="<?php echo IMG_PATH;?>2zzt_logo.png" class="f"/></p>JS仿黑客帝国字母掉落效果<span class="l">文字特效</span><span class="t">2014-06-25</span></a></dd><dd><a href="/js/text-1064.html"><p><img src="<?php echo IMG_PATH;?>2zzt_logo.png" class="f"/></p>HTML5模仿骇客帝国文字矩阵效果<span class="l">文字特效</span><span class="t">2014-06-25</span></a></dd><dd><a href="/js/website-1057.html"><p><img src="<?php echo IMG_PATH;?>2zzt_logo.png" class="f"/></p>404页面已经被外星人绑架了<span class="l">网站常用</span><span class="t">2014-06-12</span></a></dd><dd><a href="/js/date-980.html"><p><img src="<?php echo IMG_PATH;?>2zzt_logo.png" class="f"/></p>javascript显示年月日时间代码<span class="l">时间日期</span><span class="t">2013-05-08</span></a></dd>
		 </dl>	
	</div>
