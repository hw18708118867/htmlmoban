...
<link href="<?php echo CSS_PATH;?>tool/style_13_tools_md5.css" rel="stylesheet" />
...
<script type="text/javascript" src="<?php echo JS_PATH;?>tool/md5.js"></script>
<script type="text/javascript" src="<?php echo JS_PATH;?>tool/code_md5.js"></script>
...
<div id="updateTips">您的浏览器版本太低，可能会导致部分工具无法正常使用，建议您 <a href="http://windows.microsoft.com/zh-cn/internet-explorer/download-ie" target="_blank">升级IE浏览器</a> 或使用 <a href="http://www.google.cn/intl/zh-CN/chrome/browser/" target="_blank">Chrome</a>、<a href="http://firefox.com.cn/download/" target="_blank">FireFox</a>、<a href="http://www.opera.com/" target="_blank">Opera</a> 浏览。</div>
        ...
        <div class="content">
        	<div id="code" class="textbox">
                <div><textarea id="codeinp">请输入预加密的字符串！</textarea></div>
            </div>
            <div class="btnbar cl">
            	<a id="btclear" class="btns" href="javascript:void(0);" hidefocus="true">清空</a>
                <a id="btn32b" class="encrypt btns kl" href="javascript:void(0);" hidefocus="true">32位加密(大写)</a>
                <a id="btn32s" class="encrypt btns kl kr" href="javascript:void(0);" hidefocus="true">32位加密(小写)</a>
                <a id="btn16b" class="encrypt btns kl kr" href="javascript:void(0);" hidefocus="true">16位加密(大写)</a>
                <a id="btn16s" class="encrypt btns kr" href="javascript:void(0);" hidefocus="true">16位加密(小写)</a>
            </div>
            <div id="after" class="inps">
                <div><input id="afterinp" type="text"></div>
                <label for="afterinp">加密结果：</label>
            </div>
